...
const Register = () => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col  justify-center items-center  bg-[linear-gradient(45deg,rgba(0,0,0,0.2),rgba(0,0,0,0.3)),url(https://i.ibb.co/0fRTCrx/signup.jpg)] bg-center bg-cover object-cover object-center">


                <div className="flex flex-col justify-center  w-full max-w-lg mx-auto space-y-4 my-6 bg-white shadow-xl lg:px-0   px-5  lg:py-10 py-6 rounded-2xl " >



                    <div className=" mx-auto text-cyan-700">
                    ...
                    <form onSubmit={handleRegister} className="lg:w-[70%] w-full mx-auto space-y-5 rounded-lg " >
                        ...
                        <div>
                            <button className="btn text-white hover:text-cyan-700 text-xl w-full bg-cyan-700" type="submit">Register</button>
                        </div>
                    ...
                    <div className="text-center ">
                        <p className="font-medium mt-6  lg:text-base text-sm mr-2">have an account ?   Please  <Link to={'/login'} className="btn-active text-cyan-800 btn-link">Login</Link></p>
                    </div>
